...
- **DO NOT** edit, modify, or commit changes to files within submodule directories (e.g., `Rex-Omni/`)
...
# 3. Run Rex-Omni detection example (from project root)
uv run python Rex-Omni/tutorials/detection_example/detection_example.py

# Or activate venv and run normally
source .venv/bin/activate
python Rex-Omni/tutorials/detection_example/detection_example.py
```
